  ...
  return (
    <View style={styles.menu}>
                  ...
                  <View>
                    <Card>
                      ...
                      <Text style={styles.errorText}>
                        {(props.touched.whiteHoursTimer &&
                          props.errors.whiteHoursTimer) ||
                          (props.touched.whiteMinutesTimer &&
                            props.errors.whiteMinutesTimer) ||
                          (props.touched.whiteSecondsTimer &&
                            props.errors.whiteSecondsTimer)}
                      </Text>
                    </Card>
                    <Card>
                      <Text style={styles.space}></Text>
                      ...
                      <Text style={styles.errorText}>
                        {(props.touched.blackHoursTimer &&
                          props.errors.blackHoursTimer) ||
                          (props.touched.blackMinutesTimer &&
                            props.errors.blackMinutesTimer) ||
                          (props.touched.blackSecondsTimer &&
                            props.errors.blackSecondsTimer)}
                      </Text>
                    </Card>
                    <Card>
                      <CustomButton
      ...
      <Text style={styles.text}>
        {moveCounter == 0
          ? "Tap black field to begin!"
          : "Number of move: " + moveCounter}
      </Text>
